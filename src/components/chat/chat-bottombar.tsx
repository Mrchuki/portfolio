  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="relative w-full md:px-4">
        <div className="mx-auto flex items-center rounded-full border border-gray-200 dark:border-gray-800 bg-gray-100 dark:bg-gray-900 py-2 pr-2 pl-6 shadow-sm">
          <input
            ref={inputRef}
            type="text"
            value={input}
            ...
            className="text-md w-full border-none bg-transparent text-foreground placeholder:text-gray-500 focus:outline-none"
